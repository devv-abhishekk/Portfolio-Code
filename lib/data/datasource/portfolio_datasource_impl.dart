...
class PortfolioDataSourceImpl implements PortfolioDataSource {
  ...
  PersonalInfoModel getPersonalInfo() => const PersonalInfoModel(
    ...
    summary: 'Flutter Developer with 4+ years of experience building high-performance cross-platform mobile applications for Android and iOS using Flutter and Dart. Strong expertise in BLoC architecture, REST API integration, Firebase services, and payment gateway integrations including PhonePe and Razorpay. Currently working as a Freelance Flutter Developer.',
    email: 'dev.abhishekkumar81@gmail.com',
    phone: '+91 8127253679',
    linkedInUrl: 'https://linkedin.com/in/abhishekkumar',
    githubUrl: 'https://github.com/abhishekkumar',
    resumeUrl: 'https://raw.githubusercontent.com/abhishekkumar/portfolio/main/resume.pdf',
  );
  ...
  List<ProjectModel> getProjects() => const [
    ProjectModel(
      ...
      description: 'Multi-role Flutter application with store management and bulk ordering system.',
      playStoreUrl: 'https://play.google.com/store/apps/details?id=com.tribe.app',
      tags: ['Flutter', 'BLoC', 'REST API', 'Multi-role'],
    ),
    ProjectModel(
      title: 'Bharat Beej (BBSSL)',
      description: 'Agriculture seed distribution mobile application built for the Sahakar Beej network.',
      playStoreUrl: 'https://play.google.com/store/apps/details?id=com.bbssl.app',
      tags: ['Flutter', 'Firebase', 'Agriculture'],
    ),
    ProjectModel(
      title: 'Lending App',
      description: 'Secure digital loan platform with biometric authentication and PIN protection.',
      tags: ['Flutter', 'Biometrics', 'Security', 'FinTech'],
    ),
    ProjectModel(
      title: 'Saksham Express',
      description: 'Logistics tracking application with GPS tracking and real-time notifications.',
      tags: ['Flutter', 'GPS', 'Real-time'],
    ),
    ProjectModel(
      title: 'Tele Consultation App',
      description: 'Healthcare platform for appointment scheduling and doctor consultation.',
